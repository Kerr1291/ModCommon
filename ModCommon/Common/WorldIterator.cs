...
namespace ModCommon
{
    public class MapNode
    {
        ...
        public List<WorldInfo.SceneInfo> connections;
    ...
    public class WorldIterator
    {
        ...
        void AddNeighborsToQueue(MapNode node)
        {
            ...
            {
                if(remaining.ContainsKey(connection.SceneName))
                {
                    pending.Enqueue(map[connection.SceneName]);
                    remaining.Remove(connection.SceneName);
                }
            }
        }
    }
